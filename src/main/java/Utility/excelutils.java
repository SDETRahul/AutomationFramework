...
public class excelutils {
    ...
    public static void setExcelFileSheet(String sheetName) throws Exception {
        ...
        if (Platform.isMac()){
            testDataExcelPath = currentDir + "//src//main//java//Data//";
        } else if (Platform.isWindows()){
            testDataExcelPath = currentDir + "\\src\\main\\java\\Data\\";
        }
        try {
            // Open the Excel file
            FileInputStream ExcelFile = new FileInputStream(testDataExcelPath + "Data.xlsx");
    ...
    public static void setCellData(String value, int RowNum, int ColNum) throws Exception {
        try {
            ...
            fileOut = new FileOutputStream(testDataExcelPath + "Data.xlsx");
